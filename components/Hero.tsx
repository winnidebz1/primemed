...
const Hero: React.FC = () => {
  return (
    <div className="relative min-h-[90vh] lg:h-screen flex items-center overflow-hidden">
      ...
      {/* Abstract Shapes */}
      <div className="absolute top-20 right-[-10%] w-[500px] h-[500px] bg-brand-red/10 rounded-full blur-3xl"></div>
      <div className="absolute bottom-[-10%] right-20 w-[300px] h-[300px] bg-brand-blue/20 rounded-full blur-3xl"></div>

      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-32 pb-20">
        <div className="max-w-2xl text-white">
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold leading-tight mb-8">
            Reliable Medical <br />
            <span className="text-white">Equipment</span> & <span className="text-brand-red">Prime</span> <br />
            Consultation
          </h1>
          
          <p className="text-xl text-slate-100 mb-12 leading-relaxed max-w-lg">
          ...
          <div className="flex flex-col sm:flex-row gap-5">
            ...
            <a 
              href="#products" 
              className="px-10 py-4 bg-white hover:bg-slate-50 text-brand-blue rounded-xl font-bold text-lg transition-all flex items-center justify-center shadow-lg"
            >
              Explore Equipment
            </a>
          </div>
