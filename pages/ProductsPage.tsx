...
const ProductsPage: React.FC<ProductsPageProps> = ({ activeCategory, setActiveCategory }) => {
  return (
    <div className="pt-24 pb-20">
      ...
      <div className="bg-slate-900 py-24 mb-16 relative overflow-hidden">
        <div className="absolute inset-0">
          <img src="https://images.unsplash.com/photo-1579684385127-1ef15d508118?auto=format&fit=crop&q=80&w=2000" alt="background" className="w-full h-full object-cover opacity-30" />
        ...
        <div className="max-w-7xl mx-auto px-4 relative z-10 text-center text-white">
          ...
          <p className="text-xl text-slate-100 max-w-2xl mx-auto leading-relaxed opacity-90">
        ...
        <div className="flex flex-wrap gap-3 justify-center min-w-max pb-4">
          {CATEGORIES.map(cat => (
            <button 
              ...
              className={`px-8 py-3 rounded-2xl font-bold transition-all border-2 whitespace-nowrap ${
